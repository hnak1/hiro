...
最終更新: 2026-03-26（orchestrate: #18[31]・#12[31]・#13[31] Top3実行。#18: 成人低ホスホターゼ症「世界唯一」研究ポジションを様式6_研究インパクト表・面接対策_想定問答集に統合。#12・#13: 完了確認済み）
...
- [~] #10 推薦書（様式1）推薦者確定・依頼 → 推薦依頼状ドラフト・業績サマリー・候補者評価マトリクス・進捗トラッカー・フォローアップテンプレート3種（承諾後/リマインダー/受領確認）・運用チェックポイント追加済み（2026-03-18）。推薦者2名確定・推薦書受領済み。🚨 推薦書受領確認アクションシート作成（2026-03-25）: 推薦書①日付「令和8年8月13日」要確認・②署名・日付未記入→修正依頼テンプレート追加。修正受領・格納はユーザー対応
