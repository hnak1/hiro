...
- [x] #13 様式6冒頭に研究インパクト一覧表を先出し `priority:high` → 冒頭文サンプル2パターン・表1〜3テンプレート・審査員8名チェックシート・競合ポジショニングマトリクス・面接連携マップ・HPP世界唯一ポジション確定情報サマリー追加（2026-03-26）✅ **2026-04-09: 20分最終化プロトコル追加。ユーザーが表1〜3実数値記入→v4.docx保存で完全クローズ。** GitHub close: 権限制限のためCLI不可（手動要）
